...
<span class="mr-2 d-none d-lg-inline text-gray-600 small">{{ Auth::user()->name }}</span>
    ...
    <div class="container-content" style="color: black;">
         ...
         <table class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $usuario->role }}</td>
                    <td>
                        <span class="badge {{ $usuario->estado === 'activo' ? 'bg-success' : 'bg-secondary' }}" style="color: #ffffff;">
                            {{ ucfirst($usuario->estado) }}
                        </span>
                    </td>
<td>
    <!-- Cambiar Estado -->
    <form action="{{ route('admin.cambiarEstadoUsuario', $usuario->id) }}" method="POST" style="display:inline;">
        @csrf
        <button type="submit" class="btn btn-sm" style="background-color:rgb(86, 0, 97); border-color:rgb(194, 0, 161); color: white;">
            Cambiar Estado
        </button>
    </form>

    <!-- Cambiar Rol -->
    <form action="{{ route('admin.cambiarRolUsuario', $usuario->id) }}" method="POST" style="display:inline; margin-left: 5px;">
        @csrf
        <button type="submit" class="btn btn-sm btn-warning" style="background-color:rgb(86, 0, 97); border-color:rgb(194, 0, 161); color: white;">
